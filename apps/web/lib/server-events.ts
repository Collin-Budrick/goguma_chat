...
declare global {
	var __gogumaConversationEventEmitter__: EventEmitter | undefined;
	var __gogumaIndicatorEventEmitter__: EventEmitter | undefined;
}

const conversationGlobalScope = globalThis as typeof globalThis &
	Record<typeof CONVERSATION_EMITTER_GLOBAL_KEY, EventEmitter | undefined>;
const indicatorGlobalScope = globalThis as typeof globalThis &
