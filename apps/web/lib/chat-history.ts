...
export function getConversationClearedAt(conversationId: string): string | null {
  if (!conversationId) {
    return null;
  }
...
export function persistConversationClearedAt(conversationId: string): string | null {
  if (!conversationId) {
    return null;
  }
